...
Las definiciones a continuación fueron tomadas y adaptadas de \cite{taxonomy}. Una nube consiste en un conjunto de computadoras conectadas y virtualizadas que son dinámicamente proveídas y presentadas como uno o más recursos computacionales unificados. Los clientes se conectan a esta nube para poder hacer uso del servicio que se provee.
...
\bibitem{taxonomy}
	\emph{A Taxonomy and Survey of Cloud Computing Services}.
